#!/bin/bash
#SBATCH --job-name=training_internimage_h_mask2former_baseline_rebuttal
#SBATCH --output=slurm/training_internimage_h_mask2former_baseline_rebuttal_%J_%j_%a.out
#SBATCH --error=slurm/training_internimage_h_mask2former_baseline_rebuttal_%J_%j_%a.err
#SBATCH --gres=gpu:1
...
python -W ignore train.py $CONFIG \
    --work-dir /ceph/sagnihot/projects/InternImage/segmentation/work_dirs/baseline/${conventional_method}/seed_${seed} \
